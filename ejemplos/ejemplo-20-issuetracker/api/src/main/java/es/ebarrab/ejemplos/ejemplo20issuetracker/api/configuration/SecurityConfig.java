package es.ebarrab.ejemplos.ejemplo20issuetracker.api.configuration;

import es.ebarrab.ejemplos.ejemplo20issuetracker.api.filters.JwtAuthenticationFilter;

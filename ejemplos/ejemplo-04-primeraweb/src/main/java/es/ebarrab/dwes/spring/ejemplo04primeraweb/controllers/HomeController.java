package es.ebarrab.dwes.spring.ejemplo04primeraweb.controllers;


import es.ebarrab.dwes.spring.ejemplo04primeraweb.entities.User;
import es.ebarrab.dwes.spring.ejemplo04primeraweb.services.RandomService;
import es.ebarrab.dwes.spring.ejemplo04primeraweb.services.UserService;
...
public class HomeController {
    ...
    public ModelAndView index() {
        ...
        User userInDb = userService.findUserByEmail("ebarrab@educa.madrid.org");

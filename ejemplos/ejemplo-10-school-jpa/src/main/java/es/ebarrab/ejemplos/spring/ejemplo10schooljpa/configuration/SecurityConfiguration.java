package es.ebarrab.ejemplos.spring.ejemplo10schooljpa.configuration;

import es.ebarrab.ejemplos.spring.ejemplo10schooljpa.security.AlternativeSuccessHandler;
import es.ebarrab.ejemplos.spring.ejemplo10schooljpa.security.SecurityMonitor;

...
//@ControllerAdvice(assignableTypes = {StudentController.class, TeacherController.class})
//@ControllerAdvice(basePackages = {"es.ebarrab.ejemplos.spring.ejemplo10schooljpa.controllers"})
@ControllerAdvice
